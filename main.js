...
const translations = {
  en: {
    ...
    'info.location.value': 'Bastos, Yaoundé',
    ...
    'contact.addr.value':   'Building opposite Huawei Cameroon HQ\nBastos, Yaoundé, Cameroon',
    ...
    'map.title':    'Find Us',
    'map.location': 'Building opposite Huawei Cameroon HQ, Bastos, Yaoundé',
  ...
  fr: {
    ...
    'contact.addr.value':  'Bâtiment en face du siège Huawei Cameroun\nBastos, Yaoundé, Cameroun',
    ...
    'map.location': 'Bâtiment en face du siège Huawei Cameroun, Bastos, Yaoundé',
  ...
  lt: {
    ...
    'info.location.value': 'Bastos, Jaundė',
    ...
    'contact.addr.value':  'Pastatas priešais „Huawei Cameroon" būstinę\nBastos, Jaundė, Kamerūnas',
    ...
    'map.location': 'Pastatas priešais „Huawei Cameroon" būstinę, Bastos, Jaundė',
