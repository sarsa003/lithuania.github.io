...
const translations = {
  en: {
    ...
    'info.location.value': 'Rue 1.794, Bastos, Yaoundé',
    ...
    'consul.bio3':  'Mr. Sarsar is the Founder and Managing Director of Prime Nexus, a diversified holding company based in Yaoundé, operating across real estate, technology, and international trade. Bilingual in English and French.',
    'consul.bio4':  '',
    ...
    'contact.addr.value':   'Rue 1.794 Building opposite Huawei Cameroon HQ\nBastos, Yaoundé, Cameroon',
    ...
    'map.title':    'Find Us',
    'map.location': 'Rue 1.794 Building opposite Huawei Cameroon HQ, Bastos, Yaoundé',
  ...
  fr: {
    ...
    'consul.bio3':  'M. Sarsar est le fondateur et directeur général de Prime Nexus, une holding diversifiée basée à Yaoundé, opérant dans l\'immobilier, la technologie et le commerce international. Bilingue anglais-français.',
    'consul.bio4':  '',
    ...
    'contact.addr.value':  'Rue 1.794 Bâtiment en face du siège Huawei Cameroun\nBastos, Yaoundé, Cameroun',
    ...
    'map.location': 'Rue 1.794 Bâtiment en face du siège Huawei Cameroun, Bastos, Yaoundé',
  ...
  lt: {
    ...
    'info.location.value': 'Rue 1.794, Bastos, Jaundė',
    ...
    'consul.bio3':  'P. Sarsar yra Prime Nexus įkūrėjas ir generalinis direktorius — diversifikuotos holdingo bendrovės, įsikūrusios Jaundėje ir veikiančios nekilnojamojo turto, technologijų ir tarptautinės prekybos srityse. Dvikalbis anglų ir prancūzų kalbomis.',
    'consul.bio4':  '',
    ...
    'contact.addr.value':  'Rue 1.794 pastatas priešais „Huawei Cameroon" būstinę\nBastos, Jaundė, Kamerūnas',
    ...
    'map.location': 'Rue 1.794 pastatas priešais „Huawei Cameroon" būstinę, Bastos, Jaundė',
    'map.country':  'Kamerūnas',
    'map.btn':      'Atidaryti Google Maps →',
