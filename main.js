...
const translations = {
  en: {
    ...
    'contact.addr.value':   'Rue 1794, Building opposite Huawei Cameroon HQ\nBastos, Yaoundé, Cameroon',
    ...
    'map.title':    'Find Us',
    'map.location': 'Rue 1794 (Building opposite Huawei Cameroon HQ), Bastos, Yaoundé',
  ...
  fr: {
    ...
    'contact.addr.value':  'Rue 1794, Bâtiment en face du siège Huawei Cameroun\nBastos, Yaoundé, Cameroun',
    ...
    'map.location': 'Rue 1794 (Bâtiment en face du siège Huawei Cameroun), Bastos, Yaoundé',
  ...
  lt: {
    ...
    'contact.addr.value':  'Rue 1794, pastatas priešais „Huawei Cameroon" būstinę\nBastos, Jaundė, Kamerūnas',
    ...
    'map.location': 'Rue 1794 (pastatas priešais „Huawei Cameroon" būstinę), Bastos, Jaundė',
