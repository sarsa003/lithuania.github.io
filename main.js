...
const translations = {
  en: {
    ...
    'consul.bio3':  'Mr. Sarsar is the Founder and Managing Director of Prime Nexus, a Yaoundé-based firm specialising in IT consulting, cloud architecture, cybersecurity, and data services. Bilingual in English and French.',
    'consul.bio4':  '',
    ...
    'contact.addr.value':   'Rue 1794, Bastos\nYaoundé, Cameroon',
    ...
    'map.title':    'Find Us',
    'map.location': 'Rue 1794, Bastos, Yaoundé, Cameroon',
    ...
    'slide1.desc':      'A modern skyline rising beside a medieval old town — Vilnius is the fastest-growing capital in the Baltics and Europe\'s rising tech hub.',
  ...
  fr: {
    ...
    'consul.bio3':  'M. Sarsar est le fondateur et directeur général de Prime Nexus, une entreprise yaoundéaise spécialisée en conseil IT, architecture cloud, cybersécurité et services de données. Bilingue anglais-français.',
    'consul.bio4':  '',
    ...
    'slide1.desc':      'Une skyline moderne s\'élevant aux côtés d\'une vieille ville médiévale — Vilnius est la capitale à la croissance la plus rapide des pays baltes.',
    'slide2.location':  'Vilnius',
    ...
    'map.location': 'Rue 1794, Bastos, Yaoundé, Cameroun',
  ...
  lt: {
    ...
    'consul.bio3':  'P. Sarsar yra Prime Nexus įkūrėjas ir generalinis direktorius — Jaundėje įsikūrusios įmonės, specializuojančios IT konsultacijose, debesų architektūroje, kibernetiniame saugume ir duomenų paslaugose. Dvikalbis anglų ir prancūzų kalbomis.',
    'consul.bio4':  '',
    ...
    'slide1.desc':      'Modernus dangoraižių horizontas greta viduramžių senamiesčio — Vilnius yra greičiausiai auganti sostinė Baltijos šalyse ir Europos technologijų centras.',
    'slide2.location':  'Vilnius',
    ...
    'map.location': 'Rue 1794, Bastos, Jaundė, Kamerūnas',
